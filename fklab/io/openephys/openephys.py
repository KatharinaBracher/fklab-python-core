"""
=====================================================
OpenEphys file utilities (:mod:`fklab.io.openephys`)
=====================================================
...
def get_event_times(f, TTLchan=0, rising=True):
    ...
    event_times = f["event_types/TTL/events/time_samples"][
        np.logical_and(chan_mask, edge_mask)
    ]
...
def check_synchronization(t1, t2, extrapolate=False):
    ...
    cc, lags = fklab.statistics.correlation.xcorrn(
        intervals1, intervals2, scale="coeff", remove_mean=True
    )
